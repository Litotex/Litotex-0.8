...
# Dumping data for table litotex.lttx1_log: 4 rows
/*!40000 ALTER TABLE `lttx1_log` DISABLE KEYS */;
INSERT INTO `lttx1_log` (`ID`, `userid`, `logdate`, `message`, `log_type`) VALUES (1, 0, '2011-06-07 15:27:37', 'You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near \'?\' at line 1\nquery was:\nSELECT * FROM `lttx1_options` WHERE `ID` = ?', 1), (2, 0, '2011-06-07 15:27:46', 'You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near \'?\' at line 1\nquery was:\nSELECT * FROM `lttx1_options` WHERE `ID` = ?', 1), (3, 0, '2011-06-07 16:33:24', 'You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near \'?\' at line 1\nquery was:\nSELECT * FROM `lttx1_options` WHERE `ID` = ?', 1), (4, 0, '2011-06-07 16:38:22', 'You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near \'?\' at line 1\nquery was:\nSELECT * FROM `lttx1_options` WHERE `ID` = ?', 1);
...
CREATE TABLE IF NOT EXISTS `lttx1_permissions_available` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=MyISAM AUTO_INCREMENT=112544 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

# Dumping data for table litotex.lttx1_permissions_available: 100 rows
/*!40000 ALTER TABLE `lttx1_permissions_available` DISABLE KEYS */;
INSERT INTO `lttx1_permissions_available` (`ID`, `type`, `package`, `class`, `function`, `packageDir`) VALUES (106260, 2, 'tplSwitcher', 'package_tplSwitcher', 'showTemplateSwitch', ''), (106250, 1, 'tplSwitcher', 'package_tplSwitcher', 'save', ''), (112541, 1, 'acp_users', 'package_acp_users', 'delField', 'acp'), (112540, 1, 'acp_users', 'package_acp_users', 'sortFields', 'acp'), (112539, 1, 'acp_users', 'package_acp_users', 'addField', 'acp'), (112538, 1, 'acp_users', 'package_acp_users', 'fields', 'acp'), (112537, 1, 'acp_users', 'package_acp_users', 'del', 'acp'), (106259, 2, 'sample3', 'package_sample3', 'sample3', ''), (106249, 1, 'tplSwitcher', 'package_tplSwitcher', 'main', ''), (106248, 1, 'terms_and_conditions', 'package_terms_and_conditions', 'main', ''), (106247, 1, 'screenshots', 'package_screenshots', 'acp', ''), (112536, 1, 'acp_users', 'package_acp_users', 'unban', 'acp'), (112535, 1, 'acp_users', 'package_acp_users', 'ban', 'acp'), (112534, 1, 'acp_users', 'package_acp_users', 'save', 'acp'), (112533, 1, 'acp_users', 'package_acp_users', 'list', 'acp'), (112532, 1, 'acp_users', 'package_acp_users', 'edit', 'acp'), (112531, 1, 'acp_users', 'package_acp_users', 'new', 'acp'), (112530, 1, 'acp_users', 'package_acp_users', 'main', 'acp'), (112529, 1, 'acp_tplmods', 'package_acp_tplmods', 'frame', 'acp'), (112528, 1, 'acp_tplmods', 'package_acp_tplmods', 'main', 'acp'), (112543, 2, 'acp_navigation', 'package_acp_navigation', 'displayAcpSubNavigation', 'acp'), (112542, 2, 'acp_navigation', 'package_acp_navigation', 'displayAcpTopNavigation', 'acp'), (112527, 1, 'acp_projects', 'package_acp_projects', 'deleteRelease', 'acp'), (112526, 1, 'acp_projects', 'package_acp_projects', 'deleteReleaseNotSure', 'acp'), (112525, 1, 'acp_projects', 'package_acp_projects', 'uploadReleaseSave', 'acp'), (112524, 1, 'acp_projects', 'package_acp_projects', 'uploadRelease', 'acp'), (112523, 1, 'acp_projects', 'package_acp_projects', 'deleteProjectNotSure', 'acp'), (106246, 1, 'screenshots', 'package_screenshots', 'frontend', ''), (112522, 1, 'acp_projects', 'package_acp_projects', 'deleteProject', 'acp'), (112521, 1, 'acp_projects', 'package_acp_projects', 'editProjectSave', 'acp'), (112520, 1, 'acp_projects', 'package_acp_projects', 'editProject', 'acp'), (112519, 1, 'acp_projects', 'package_acp_projects', 'createProjectSave', 'acp'), (106257, 2, 'sample1', 'package_sample1', 'sample1', ''), (106258, 2, 'sample2', 'package_sample2', 'sample2', ''), (112518, 1, 'acp_projects', 'package_acp_projects', 'createProject', 'acp'), (112517, 1, 'acp_projects', 'package_acp_projects', 'main', 'acp'), (106254, 2, 'navigation', 'package_navigation', 'displaySubNavigation', ''), (106245, 1, 'screenshots', 'package_screenshots', 'main', ''), (112516, 1, 'acp_permissions', 'package_acp_permissions', 'save', 'acp'), (106244, 1, 'sample3', 'package_sample3', 'main', ''), (112515, 1, 'acp_permissions', 'package_acp_permissions', 'main', 'acp'), (112514, 1, 'acp_packageManager', 'package_acp_packageManager', 'setQueueDetails', 'acp'), (112513, 1, 'acp_packageManager', 'package_acp_packageManager', 'displayUpdateQueue', 'acp'), (112512, 1, 'acp_packageManager', 'package_acp_packageManager', 'installPackage', 'acp'), (112511, 1, 'acp_packageManager', 'package_acp_packageManager', 'processUpdateQueue', 'acp'), (112510, 1, 'acp_packageManager', 'package_acp_packageManager', 'processUpdates', 'acp'), (112509, 1, 'acp_packageManager', 'package_acp_packageManager', 'updateRemoteList', 'acp'), (112508, 1, 'acp_packageManager', 'package_acp_packageManager', 'listUpdates', 'acp'), (112507, 1, 'acp_packageManager', 'package_acp_packageManager', 'listInstalled', 'acp'), (112506, 1, 'acp_packageManager', 'package_acp_packageManager', 'main', 'acp'), (106243, 1, 'register', 'package_register', 'register_submit', ''), (106242, 1, 'register', 'package_register', 'main', ''), (106241, 1, 'projects', 'package_projects', 'getList', ''), (106255, 2, 'news', 'package_news', 'showNewsBlock', ''), (106256, 2, 'register', 'package_register', 'showRegisterLink', ''), (106240, 1, 'projects', 'package_projects', 'main', ''), (106239, 1, 'privacy_policy', 'package_privacy_policy', 'main', ''), (106238, 1, 'news', 'package_news', 'showComments', ''), (112504, 1, 'acp_options', 'package_acp_options', 'save', 'acp'), (112505, 1, 'acp_options', 'package_acp_options', 'del', 'acp'), (106237, 1, 'news', 'package_news', 'main', ''), (106236, 1, 'main', 'package_main', 'main', ''), (106253, 2, 'navigation', 'package_navigation', 'displayTopNavigation', ''), (106252, 2, 'login', 'package_login', 'showLoginBox', ''), (106235, 1, 'mail', 'package_mail', 'main', ''), (106234, 1, 'login', 'package_login', 'forget_submit', ''), (106233, 1, 'login', 'package_login', 'forget', ''), (112503, 1, 'acp_options', 'package_acp_options', 'list', 'acp'), (112502, 1, 'acp_options', 'package_acp_options', 'edit', 'acp'), (112501, 1, 'acp_options', 'package_acp_options', 'new', 'acp'), (112500, 1, 'acp_options', 'package_acp_options', 'main', 'acp'), (112499, 1, 'acp_main', 'package_acp_main', 'main_redirect', 'acp'), (112498, 1, 'acp_main', 'package_acp_main', 'main', 'acp'), (112497, 1, 'acp_log_viewer', 'package_acp_log_viewer', 'del_logs', 'acp'), (112496, 1, 'acp_log_viewer', 'package_acp_log_viewer', 'database', 'acp'), (112495, 1, 'acp_log_viewer', 'package_acp_log_viewer', 'show_log', 'acp'), (112494, 1, 'acp_log_viewer', 'package_acp_log_viewer', 'show_log_database', 'acp'), (112493, 1, 'acp_log_viewer', 'package_acp_log_viewer', 'main', 'acp'), (112492, 1, 'acp_login', 'package_acp_login', 'loginSubmit', 'acp'), (112491, 1, 'acp_login', 'package_acp_login', 'main', 'acp'), (112489, 1, 'acp_groups', 'package_acp_groups', 'save', 'acp'), (106232, 1, 'login', 'package_login', 'logout', ''), (106231, 1, 'login', 'package_login', 'loginsubmit', ''), (106230, 1, 'login', 'package_login', 'main', ''), (112490, 1, 'acp_groups', 'package_acp_groups', 'del', 'acp'), (112488, 1, 'acp_groups', 'package_acp_groups', 'list', 'acp'), (112487, 1, 'acp_groups', 'package_acp_groups', 'edit', 'acp'), (106251, 2, 'edit_profile', 'package_edit_profile', 'showProfileLink', ''), (106229, 1, 'impressum', 'package_impressum', 'main', ''), (106227, 1, 'edit_profile', 'package_edit_profile', 'profile_submit', ''), (106228, 1, 'errorPage', 'package_errorPage', '404', ''), (106226, 1, 'edit_profile', 'package_edit_profile', 'main', ''), (106225, 1, 'core_acp', 'package_core_acp', 'tplModSave', ''), (106224, 1, 'core_acp', 'package_core_acp', 'tplModSort', ''), (106223, 1, 'core_acp', 'package_core_acp', 'main', ''), (106222, 1, 'content', 'package_content', 'main', ''), (112486, 1, 'acp_groups', 'package_acp_groups', 'new', 'acp'), (112485, 1, 'acp_groups', 'package_acp_groups', 'main', 'acp'), (112484, 1, 'acp_errorPage', 'package_acp_errorPage', '404', 'acp'), (112483, 1, 'acp_diff', 'package_acp_diff', 'main', 'acp');
...
# Dumping data for table litotex.lttx1_sessions: 18 rows
...
) ENGINE=MyISAM AUTO_INCREMENT=70724 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
INSERT INTO `lttx1_tpl_modification_sort` (`ID`, `class`, `function`, `position`, `active`, `sort`, `packageDir`) VALUES (70517, 'package_news', 'showNewsBlock', 'content', 1, 0, ''), (70516, 'package_navigation', 'displayTopNavigation', 'TopNavi', 1, 0, ''), (70515, 'package_navigation', 'displaySubNavigation', 'SubNavi', 1, 0, ''), (70723, 'package_acp_navigation', 'displayAcpTopNavigation', 'acpTopNavi', 1, 0, 'acp'), (70513, 'package_tplSwitcher', 'showTemplateSwitch', 'right', 1, 1, ''), (70722, 'package_acp_navigation', 'displayAcpSubNavigation', 'acpSubNavi', 1, 0, 'acp'), (70514, 'package_edit_profile', 'showProfileLink', 'right', 1, 2, ''), (70512, 'package_login', 'showLoginBox', 'right', 1, 0, ''), (70511, 'package_register', 'showRegisterLink', 'none', 0, 3, ''), (70510, 'package_sample3', 'sample3', 'none', 0, 2, ''), (70509, 'package_sample1', 'sample1', 'none', 0, 1, ''), (70508, 'package_sample2', 'sample2', 'none', 0, 0, '');
