...
CREATE TABLE IF NOT EXISTS `lttx1_permissions_available` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=MyISAM AUTO_INCREMENT=57628 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
INSERT INTO `lttx1_permissions_available` (`ID`, `type`, `package`, `class`, `function`, `packageDir`) VALUES (53088, 1, 'acp_users', 'package_acp_users', 'delField', 'acp'), (57617, 1, 'tplSwitcher', 'package_tplSwitcher', 'save', ''), (57627, 2, 'tplSwitcher', 'package_tplSwitcher', 'showTemplateSwitch', ''), (57626, 2, 'sample3', 'package_sample3', 'sample3', ''), (57616, 1, 'tplSwitcher', 'package_tplSwitcher', 'main', ''), (57615, 1, 'terms_and_conditions', 'package_terms_and_conditions', 'main', ''), (57614, 1, 'sample3', 'package_sample3', 'main', ''), (53087, 1, 'acp_users', 'package_acp_users', 'sortFields', 'acp'), (53086, 1, 'acp_users', 'package_acp_users', 'addField', 'acp'), (53085, 1, 'acp_users', 'package_acp_users', 'fields', 'acp'), (53084, 1, 'acp_users', 'package_acp_users', 'del', 'acp'), (53083, 1, 'acp_users', 'package_acp_users', 'unban', 'acp'), (53082, 1, 'acp_users', 'package_acp_users', 'ban', 'acp'), (53081, 1, 'acp_users', 'package_acp_users', 'save', 'acp'), (53080, 1, 'acp_users', 'package_acp_users', 'list', 'acp'), (53079, 1, 'acp_users', 'package_acp_users', 'edit', 'acp'), (53078, 1, 'acp_users', 'package_acp_users', 'new', 'acp'), (53077, 1, 'acp_users', 'package_acp_users', 'main', 'acp'), (53076, 1, 'acp_tplmods', 'package_acp_tplmods', 'frame', 'acp'), (53075, 1, 'acp_tplmods', 'package_acp_tplmods', 'main', 'acp'), (53090, 2, 'acp_navigation', 'package_acp_navigation', 'displayAcpSubNavigation', 'acp'), (53089, 2, 'acp_navigation', 'package_acp_navigation', 'displayAcpTopNavigation', 'acp'), (53072, 1, 'acp_projects', 'package_acp_projects', 'uploadReleaseSave', 'acp'), (53074, 1, 'acp_projects', 'package_acp_projects', 'deleteRelease', 'acp'), (53073, 1, 'acp_projects', 'package_acp_projects', 'deleteReleaseNotSure', 'acp'), (53069, 1, 'acp_projects', 'package_acp_projects', 'deleteProject', 'acp'), (57613, 1, 'register', 'package_register', 'register_submit', ''), (53071, 1, 'acp_projects', 'package_acp_projects', 'uploadRelease', 'acp'), (53070, 1, 'acp_projects', 'package_acp_projects', 'deleteProjectNotSure', 'acp'), (53068, 1, 'acp_projects', 'package_acp_projects', 'editProjectSave', 'acp'), (57624, 2, 'sample1', 'package_sample1', 'sample1', ''), (57625, 2, 'sample2', 'package_sample2', 'sample2', ''), (53067, 1, 'acp_projects', 'package_acp_projects', 'editProject', 'acp'), (53066, 1, 'acp_projects', 'package_acp_projects', 'createProjectSave', 'acp'), (57621, 2, 'navigation', 'package_navigation', 'displaySubNavigation', ''), (57611, 1, 'projects', 'package_projects', 'getList', ''), (53065, 1, 'acp_projects', 'package_acp_projects', 'createProject', 'acp'), (57612, 1, 'register', 'package_register', 'main', ''), (57610, 1, 'projects', 'package_projects', 'main', ''), (57609, 1, 'privacy_policy', 'package_privacy_policy', 'main', ''), (53064, 1, 'acp_projects', 'package_acp_projects', 'main', 'acp'), (53063, 1, 'acp_permissions', 'package_acp_permissions', 'save', 'acp'), (53062, 1, 'acp_permissions', 'package_acp_permissions', 'main', 'acp'), (53061, 1, 'acp_packageManager', 'package_acp_packageManager', 'setQueueDetails', 'acp'), (53059, 1, 'acp_packageManager', 'package_acp_packageManager', 'installPackage', 'acp'), (53060, 1, 'acp_packageManager', 'package_acp_packageManager', 'displayUpdateQueue', 'acp'), (53057, 1, 'acp_packageManager', 'package_acp_packageManager', 'processUpdates', 'acp'), (53058, 1, 'acp_packageManager', 'package_acp_packageManager', 'processUpdateQueue', 'acp'), (53056, 1, 'acp_packageManager', 'package_acp_packageManager', 'updateRemoteList', 'acp'), (53055, 1, 'acp_packageManager', 'package_acp_packageManager', 'listUpdates', 'acp'), (57608, 1, 'news', 'package_news', 'showComments', ''), (57607, 1, 'news', 'package_news', 'main', ''), (57606, 1, 'main', 'package_main', 'main', ''), (57622, 2, 'news', 'package_news', 'showNewsBlock', ''), (57623, 2, 'register', 'package_register', 'showRegisterLink', ''), (57605, 1, 'mail', 'package_mail', 'main', ''), (57604, 1, 'login', 'package_login', 'forget_submit', ''), (57603, 1, 'login', 'package_login', 'forget', ''), (53053, 1, 'acp_packageManager', 'package_acp_packageManager', 'main', 'acp'), (57602, 1, 'login', 'package_login', 'logout', ''), (57601, 1, 'login', 'package_login', 'loginsubmit', ''), (57620, 2, 'navigation', 'package_navigation', 'displayTopNavigation', ''), (57619, 2, 'login', 'package_login', 'showLoginBox', ''), (57600, 1, 'login', 'package_login', 'main', ''), (57598, 1, 'errorPage', 'package_errorPage', '404', ''), (57599, 1, 'impressum', 'package_impressum', 'main', ''), (53054, 1, 'acp_packageManager', 'package_acp_packageManager', 'listInstalled', 'acp'), (53052, 1, 'acp_main', 'package_acp_main', 'main_redirect', 'acp'), (53051, 1, 'acp_main', 'package_acp_main', 'main', 'acp'), (53050, 1, 'acp_log_viewer', 'package_acp_log_viewer', 'del_logs', 'acp'), (53049, 1, 'acp_log_viewer', 'package_acp_log_viewer', 'database', 'acp'), (53048, 1, 'acp_log_viewer', 'package_acp_log_viewer', 'show_log', 'acp'), (53047, 1, 'acp_log_viewer', 'package_acp_log_viewer', 'show_log_database', 'acp'), (53046, 1, 'acp_log_viewer', 'package_acp_log_viewer', 'main', 'acp'), (53045, 1, 'acp_login', 'package_acp_login', 'loginSubmit', 'acp'), (53044, 1, 'acp_login', 'package_acp_login', 'main', 'acp'), (53043, 1, 'acp_groups', 'package_acp_groups', 'del', 'acp'), (53042, 1, 'acp_groups', 'package_acp_groups', 'save', 'acp'), (53041, 1, 'acp_groups', 'package_acp_groups', 'list', 'acp'), (53040, 1, 'acp_groups', 'package_acp_groups', 'edit', 'acp'), (57597, 1, 'edit_profile', 'package_edit_profile', 'profile_submit', ''), (57596, 1, 'edit_profile', 'package_edit_profile', 'main', ''), (57595, 1, 'core_acp', 'package_core_acp', 'tplModSave', ''), (53038, 1, 'acp_groups', 'package_acp_groups', 'main', 'acp'), (53039, 1, 'acp_groups', 'package_acp_groups', 'new', 'acp'), (53037, 1, 'acp_errorPage', 'package_acp_errorPage', '404', 'acp'), (53036, 1, 'acp_diff', 'package_acp_diff', 'main', 'acp'), (57618, 2, 'edit_profile', 'package_edit_profile', 'showProfileLink', ''), (57594, 1, 'core_acp', 'package_core_acp', 'tplModSort', ''), (57593, 1, 'core_acp', 'package_core_acp', 'main', ''), (57592, 1, 'content', 'package_content', 'main', '');
...
# Dumping data for table litotex.lttx1_sessions: 0 rows
...
) ENGINE=MyISAM AUTO_INCREMENT=63942 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
INSERT INTO `lttx1_tpl_modification_sort` (`ID`, `class`, `function`, `position`, `active`, `sort`, `packageDir`) VALUES (63941, 'package_navigation', 'displayTopNavigation', 'TopNavi', 1, 0, ''), (63940, 'package_register', 'showRegisterLink', 'right', 1, 4, ''), (63939, 'package_login', 'showLoginBox', 'right', 1, 3, ''), (62631, 'package_acp_navigation', 'displayAcpSubNavigation', 'acpSubNavi', 1, 0, 'acp'), (63938, 'package_edit_profile', 'showProfileLink', 'right', 1, 2, ''), (62630, 'package_acp_navigation', 'displayAcpTopNavigation', 'acpTopNavi', 1, 0, 'acp'), (63937, 'package_tplSwitcher', 'showTemplateSwitch', 'right', 1, 1, ''), (63936, 'package_news', 'showNewsBlock', 'right', 1, 0, ''), (63935, 'package_navigation', 'displaySubNavigation', 'SubNavi', 1, 0, ''), (63934, 'package_sample3', 'sample3', 'none', 0, 2, ''), (63933, 'package_sample1', 'sample1', 'none', 0, 1, ''), (63932, 'package_sample2', 'sample2', 'none', 0, 0, '');
