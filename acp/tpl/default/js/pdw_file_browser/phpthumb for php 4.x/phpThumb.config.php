...
//$PHPTHUMB_CONFIG['cache_directory'] = dirname(__FILE__).'/../cache1/'.$_SESSION['uploadfolder'];                            // set the cache directory relative to the phpThumb() installation
 $PHPTHUMB_CONFIG['cache_directory']='./../../../../cach5';
