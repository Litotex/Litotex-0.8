...
<div class="login">
<form class="cmxform" id="registerForm" method="post" action="index.php?package=acp_login&amp;action=forget_submit">
	<fieldset class="ui-widget ui-widget-content ui-corner-all">
		<legend class="ui-widget ui-widget-header ui-corner-all">{#LN_LOGIN_FORGET_NOTE1#}</legend>
		<p>
